...
export const alt = "Roast My Page vs Hotjar — comparison";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: 18, marginTop: 90 }}>
          ...
          <div style={{ fontSize: 130, fontWeight: 800, color: "#f97316", lineHeight: 1 }}>Hotjar</div>
        </div>
        <div style={{ fontSize: 34, fontWeight: 700, marginTop: 30, color: "#f7f7f8", maxWidth: 900, lineHeight: 1.2 }}>
          Analytics vs audit. Heatmaps show the where — we explain the why.
        </div>
        <div style={{ marginTop: "auto", fontSize: 22, color: "#a1a1aa" }}>roastmypage.com/vs/hotjar</div>
      </div>
    ),
    { ...size, fonts },
  );
